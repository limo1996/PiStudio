...
{
	public static class ImagePathSaver
	{
		/***********************************************************************************************
		...
		internal static bool CohenSutherlandLineClipWithViewPortOffset(Rectangle viewPort, ref float xi0, ref float yi0, ref float xi1, ref float yi1, int offset)
		{
			var viewPortWithOffset = new Rectangle(viewPort.X - offset, viewPort.Y - offset, viewPort.Width + 2 * offset, viewPort.Height + 2 * offset);

			return CohenSutherlandLineClip(viewPortWithOffset, ref xi0, ref yi0, ref xi1, ref yi1);
		}

		internal static bool CohenSutherlandLineClip(Rectangle extents, ref float xi0, ref float yi0, ref float xi1, ref float yi1)
		{
		...
		internal static bool CohenSutherlandLineClip(Rectangle extents, ref int xi0, ref int yi0, ref int xi1, ref int yi1)
		{
			double x0 = xi0;
			double y0 = yi0;
			double x1 = xi1;
		...
		/// <returns></returns>
		private static byte ComputeOutCode(Rectangle extents, double x, double y)
		{
		...
		internal static bool CohenSutherlandLineClip(Rectangle extents, ref double x0, ref double y0, ref double x1, ref double y1)
		{
		...
		public static void AAWidthLine(int width, int height, int[] buffer, float x1, float y1, float x2, float y2, float lineWidth, int color)
		{
			...
			if (!CohenSutherlandLineClip(new Rectangle(0, 0, width, height), ref x1, ref y1, ref x2, ref y2)) return;
